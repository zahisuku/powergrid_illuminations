...
public class ModCreativeTabs {
    ...
    public static RegistrySupplier<CreativeModeTab> POWERGRID_ILLUMINATIONS_TAB = TABS.register(
            "powergrid_illuminations_tab",
            () ->
                CreativeTabRegistry.create(
                    Component.translatable("category.powergrid_illuminations_tab"), // tab title
                    () -> new ItemStack(ModItems.LED_BLOCK_ITEM.get()) // tab icon
                )
        );
